...
class SiteViewsTests(unittest.TestCase):
    ...
    def test_record_increments(self):
        self.assertEqual(site_views.record_site_view(), site_views.VIEWS_PER_PAGE_LOAD)
        self.assertEqual(
            site_views.record_site_view(), site_views.VIEWS_PER_PAGE_LOAD * 2
        )
        self.assertEqual(
            site_views.get_site_view_count(), site_views.VIEWS_PER_PAGE_LOAD * 2
        )
    ...
    def test_system_stats_includes_view_count(self):
        ...
        self.assertEqual(data["viewCount"], site_views.VIEWS_PER_PAGE_LOAD)
